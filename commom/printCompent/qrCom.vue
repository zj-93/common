<template>
  <div ref="settlePrintNew" v-show="false">
    <div>
      <div v-for="(item,index) in QRCodeList.data" :key="index" style="width:50mm;height:29.9mm;display:flex;justify-content: space-between;border: 0px solid #ccc; overflow:hidden;">
